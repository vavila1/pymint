...
<h1 class="h3 mb-2 text-gray-800" align="center">Registrar Cliente</h1>
<br>
<form class="user" method="POST" action="{{route('clientes.store')}}">
    @csrf
    <div class="form-group row">
        <div class="col-sm-6 mb-3 mb-sm-0">
            <input type="text" class="form-control form-control-user" id="" placeholder="Nombre del cliente" name="nombre" required>
        </div>
        <div class=" col-sm-6">
